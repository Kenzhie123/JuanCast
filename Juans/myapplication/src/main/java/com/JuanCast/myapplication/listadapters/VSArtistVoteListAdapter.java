                                ...
                                public void onSuccess(Date serverTime) {
                                    ...
                                    if(data.containsKey("active_powerup"))
                                    {
                                        if(data.get("active_powerup")!= "")
                                        {
                                            ...
                                            {
                                                activePowerup = (String) data.get("active_powerup");
                                            }
                                        }
                                    ...
                                    Log.d("POWERUPTAG",activePowerup);
                                    ...
                                    TextView CVP_PowerupActive = dialog.findViewById(R.id.CVP_PowerupActive);
                                    ...
                                    {
                                        CVP_PowerupActive.setVisibility(View.VISIBLE);
                                        CVP_PowerupActive.setText(Tools.getPowerupNameFromProductID(activePowerup));
                                    }
                                    ...
                                    String finalActivePowerup = activePowerup;
                                    CVP_CastVoteButton.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            else
                                            {
                                                ...
                                                long totalVotes = Long.parseLong(CVP_VoteCountField.getText().toString());

                                                if(pollType.equals("Minor") && finalActivePowerup.equals(ProductIDS.AGIMAT_NI_JUAN))
                                                {
                                                    totalVotes *= 2;
                                                }
                                                else if(pollType.equals("Major") && finalActivePowerup.equals(ProductIDS.APOLAKI)){
                                                    totalVotes *= 2;
                                                }

                                                pollUpdate.put((pollType.equals("Minor")? "star_votes" : "sun_votes"), finalVoteAmount +totalVotes);
